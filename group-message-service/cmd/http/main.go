...
import (
	...
	groupMessageGRPC "group-message-service/internal/gRPC"
	groupMessageGRPCGen "group-message-service/internal/gRPC/group-message-service-grpc-gen"
...
func buildServer() (*grpc.Server, func(), error) {
	...
	serverRegistrar := grpc.NewServer(
		grpc.ChainUnaryInterceptor(groupMessageGRPC.Interceptors()...),
	)

	service := &groupMessageGRPC.GroupGroupMessageServiceServer{}
	groupMessageGRPCGen.RegisterGroupMessageServiceServer(serverRegistrar, service)
